...
import { iauResultFeatures, iauResults } from "@/content/integraciones";
...
const featureIcons = {
  ...
  (typeof iauResultFeatures)[number]["icon"],
  LucideIcon
>;

export function IauResults() {
  return (
