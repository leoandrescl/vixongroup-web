...
const cardIcons = {
  ...
  list: ClipboardList,
  users: Users,
} as const satisfies Record<(typeof iauStrategyCards)[number]["icon"], LucideIcon>;

export function IauStrategy() {
  return (
      ...
      <Container>
        <div className="grid items-stretch gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-10 xl:gap-12">
          <div className="flex flex-col">
            <Reveal>
              <Eyebrow className="text-[#00c8ea]">{iauStrategy.eyebrow}</Eyebrow>
