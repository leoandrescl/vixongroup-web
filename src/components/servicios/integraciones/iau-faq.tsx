...
import { integracionesFaqs } from "@/content/integraciones";
import { cn } from "@/lib/utils";

export function IauFaq() {
  const left = integracionesFaqs.slice(0, 3);
  const right = integracionesFaqs.slice(3);
