...
const cardIcons = {
  ...
  users: Users,
} as const satisfies Record<(typeof mktStrategyCards)[number]["icon"], LucideIcon>;

export function MktStrategy() {
  return (
      ...
      <Container>
        <div className="grid items-stretch gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:gap-10 xl:gap-12">
          <div className="flex flex-col">
            <Reveal>
              <Eyebrow className="text-[#00c8ea]">{mktStrategy.eyebrow}</Eyebrow>
