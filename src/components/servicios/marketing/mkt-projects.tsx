...
import { mktRecentProjects } from "@/content/marketing";

export function MktProjects() {
  return (
    <Section className="scroll-mt-24 bg-white text-canvas-foreground">
      <Container>
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <Reveal>
            ...
            <h2 className="mt-3 max-w-xl text-3xl font-semibold tracking-tight text-balance md:text-4xl lg:text-[2.35rem] lg:leading-[1.12]">
              Estrategias que generan resultados reales.
            </h2>
          </Reveal>
          <Reveal delay={50}>
            <Button
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {mktRecentProjects.map((project, index) => (
