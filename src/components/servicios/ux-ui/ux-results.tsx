...
import { uxResultFeatures, uxResults } from "@/content/ux-ui";
...
const featureIcons = {
  ...
  devices: Smartphone,
  a11y: Accessibility,
  hierarchy: SquareStack,
  consistency: ThumbsUp,
  conversion: TrendingUp,
  improve: Wrench,
} as const satisfies Record<
  (typeof uxResultFeatures)[number]["icon"],
  LucideIcon
>;

export function UxResults() {
  return (
