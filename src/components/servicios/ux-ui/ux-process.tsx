...
import { uxProcessSteps } from "@/content/ux-ui";
...
const stepIcons = {
  ...
  cog: Settings,
  rocket: Rocket,
} as const satisfies Record<(typeof uxProcessSteps)[number]["icon"], LucideIcon>;
      ...
      <Container>
        ...
        <ol className="mt-10 grid grid-cols-2 gap-8 overflow-visible lg:grid-cols-6 lg:gap-0">
          {uxProcessSteps.map((step, index) => {
            ...
            const isLast = index === uxProcessSteps.length - 1;
