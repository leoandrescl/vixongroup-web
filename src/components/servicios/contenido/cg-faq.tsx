...
import { contenidoFaqs } from "@/content/contenido";
import { cn } from "@/lib/utils";

export function CgFaq() {
  const left = contenidoFaqs.slice(0, 3);
  const right = contenidoFaqs.slice(3);
