...
import { smResultFeatures, smResults } from "@/content/software-medida";
...
const featureIcons = {
  ...
  (typeof smResultFeatures)[number]["icon"],
  LucideIcon
>;

export function SmResults() {
  return (
