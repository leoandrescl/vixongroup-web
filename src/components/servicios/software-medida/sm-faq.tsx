...
import { softwareMedidaFaqs } from "@/content/software-medida";
import { cn } from "@/lib/utils";

export function SmFaq() {
  const left = softwareMedidaFaqs.slice(0, 3);
  const right = softwareMedidaFaqs.slice(3);
