...
import { anResultFeatures, anResults } from "@/content/analitica";
...
const featureIcons = {
  ...
  (typeof anResultFeatures)[number]["icon"],
  LucideIcon
>;

export function AnResults() {
  return (
