      ...
      <Container>
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] py-5 shadow-[0_0_40px_-20px_rgb(0_163_173_/_0.35)] backdrop-blur-md md:rounded-3xl md:py-6">
          ...
          <div className="relative">
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 bg-linear-to-r from-[#0c111b] to-transparent md:w-16" />
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 bg-linear-to-l from-[#0c111b] to-transparent md:w-16" />
