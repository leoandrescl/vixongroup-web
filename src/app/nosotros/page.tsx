        ...
        <Container>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            {manifesto.map((item) => (
              <article
                key={item.title}
                className="rounded-3xl bg-background p-7 ring-1 ring-white/8"
              >
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-canvas-foreground hover:text-brand"
                  >
